...
namespace {
    ...
    constexpr uint16_t bm_write_ddram_data{0b10'0000'0000};
    constexpr uint16_t bm_set_ddram_addr{0b00'1000'0000};
    constexpr uint16_t bm_ddram_addr{0b00'0111'1111};
    constexpr uint16_t bm_ddram_data{0b00'1111'1111};
